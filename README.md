...
* Syncs data once every minute with PM 10.0 and PM 2.5 readings from the Nova PM (SDS011) Sensor, Temperature reading from the DS18820 Temperature Sensor and GPS positioning values (longitude, latitude). 
