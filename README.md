...
* Testing consisted of full battery discharge with an active full time use. Wi-Fi was connected to a network, syncs data once every minute with PM 10.0 and PM 2.5 readings from the Nova PM (SDS011) Sensor and GPS positioning values (longitude, latitude). Battery life varies significantly with settings, usage and other factors.
